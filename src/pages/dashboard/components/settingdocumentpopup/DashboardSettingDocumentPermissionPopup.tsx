...
interface DashboardSettingDocumentPermissionPopupProps {open: boolean;onClose: () => void;}

const DashboardSettingDocumentPermissionPopup: React.FC<DashboardSettingDocumentPermissionPopupProps> = ({open,onClose,}) => {
...
export default DashboardSettingDocumentPermissionPopup;
