...
interface DashboardSettingFolderMovePopupProps {open: boolean;onClose: () => void;}

const DashboardSettingFolderMovePopup: React.FC<DashboardSettingFolderMovePopupProps> = ({open,onClose,}) => {
...
export default DashboardSettingFolderMovePopup;
